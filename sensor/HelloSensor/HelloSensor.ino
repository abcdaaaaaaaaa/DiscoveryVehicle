...
break;
    ...
    if( tflI2C.getData( tfDist, tfFlux, tfTemp, tfAddr))
    {
        ...
        myservo.write(0);
        Angle0 = tfDist;   
        Green0 = map(tfFlux,0,65535,255,0);
        Temp0 = tfTemp;
        delay(0.5);        
        myservo.write(30);
        Angle30 = tfDist;   
        Green30 = map(tfFlux,0,65535,255,0);
        Temp30 = tfTemp;
        delay(0.5);        
        myservo.write(60);
        Angle60 = tfDist;   
        Green60 = map(tfFlux,0,65535,255,0);
        Temp60 = tfTemp;
        delay(0.5);        
        myservo.write(90);
        Angle90 = tfDist;   
        Green90 = map(tfFlux,0,65535,255,0);
        Temp90 = tfTemp;
        delay(0.5);        
        myservo.write(120);
        Angle120 = tfDist;   
        Green120 = map(tfFlux,0,65535,255,0);
        Temp120 = tfTemp;
        delay(0.5);        
        myservo.write(150);
        Angle150 = tfDist;   
        Green150 = map(tfFlux,0,65535,255,0);
        Temp150 = tfTemp;
        delay(0.5);        
        myservo.write(180);
        Angle180 = tfDist;   
        Green180 = map(tfFlux,0,65535,255,0);
        Temp180 = tfTemp;
        delay(0.5);        
    }
