...
void vites(){
if (xox == "D"){
minimum = 25;  // 274.51 RPM // (500+/-49.02)
maximum = 255;
}
else if (xox == "L"){ 
...
minimum = 25;  // 122.55 RPM // (196.08+/-49.02)
maximum = 100;
}
else if (xox == "B"){ 
minimum = 25;  // 171.57 RPM // (294.12+/-49.02)
maximum = 150;
}
else if (xox == "C"){ 
minimum = 25;  // 220.59 RPM // (392.16+/-49.02)
maximum = 200;
}
else if (xox == "E"){
minimum = 65;  // 313.725 RPM // (500+/-127.45)
maximum = 255;
}
else if (xox == "F"){
minimum = 105;  // 352.94 RPM // (500+/-205.88)
maximum = 255;
}
else if (xox == "G"){
minimum = 145;  // 391.175 RPM // (500+/-282.35)
maximum = 255;
}
else if (xox == "H"){  
minimum = 255;  // 500 RPM // (500+/-500) 
maximum = 255;
}
else{
minimum = 25;
