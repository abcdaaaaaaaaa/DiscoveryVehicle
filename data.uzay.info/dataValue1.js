 ...
 let toplam1 = parseInt(field1Values);   
 let toplam2 = parseInt(field2Values);   
 let toplam3 = parseInt(field3Values);   
 let toplam4 = parseInt(field4Values);   
 let toplam5 = parseInt(field5Values);   
 let toplam6 = parseInt(field6Values);
 let toplam7 = parseInt(field7Values);   
 let toplam8 = parseInt(field8Values);   
