        $(document).ready(function() {
            function getData() {
                var url ="https://api.thingspeak.com/channels/2195036/fields/1,2,3,4,5,6,7.json?api_key=DG5Q1OBE0MW2GDTF&results=1";
 ...
 let toplam9 =  parseInt(field1Values);   
 let toplam10 = parseInt(field2Values);   
 let toplam11 = parseInt(field3Values);   
 let toplam12 = parseInt(field4Values);
 let toplam13 = parseInt(field5Values);    
 let toplam14 = parseInt(field6Values)/(10**6);   
 let toplam15 = parseInt(field7Values)/(10**6);   
