setInterval(() => {
		...
		let Heightdeviation = screenHeight * Math.sqrt(3) / 3;
		let pixellength = 15; // This is the length of the square (pixel).
		let Npixellength = 15; // It is the deviation pixel caused by two different containers.
		let Fullpixellength = pixellength * 2;
	    let Widthcoefficient = screenWidth / Average;
	    let Heightcoefficient = screenHeight / Average;
		let UnitDistance = screenHeight - pixellength;
		let FullUnitDistance = screenHeight - Fullpixellength;
