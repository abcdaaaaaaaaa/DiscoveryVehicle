...
<script>
var Angle0 = 0, Angle15 = 0, Angle30 = 0, Angle45 = 0, Angle60 = 0, Angle75 = 0, Angle90 = 0, Angle105 = 0, Angle120 = 0, Angle135 = 0, Angle150 = 0, Angle165 = 0, Angle180 = 0;
var NoAngle15 = 0, NoAngle30 = 0, NoAngle45 = 0, NoAngle60 = 0, NoAngle75 = 0, NoAngle90 = 0, NoAngle105 = 0, NoAngle120 = 0, NoAngle135 = 0, NoAngle150 = 0, NoAngle165 = 0;
var Average = 0;
var rgb0 = "", rgb15 = "", rgb30 = "", rgb45 = "", rgb60 = "", rgb75 = "", rgb90 = "", rgb105 = "", rgb120 = "", rgb135 = "", rgb150 = "", rgb165 = "", rgb180 = "", rgb195 = "", rgb210 = "", rgb225 = "", rgb240 = "", rgb255 = "", rgb270 = "", rgb285 = "", rgb300 = "", rgb315 = "", rgb330 = "", rgb345 = "";

function updateDashboard() {
    $.getJSON('datareceiver.php?axis=Y', function(data) {
        if (data.success) {
            Angle0 = parseFloat(data.dist.Dist0); Angle15 = parseFloat(data.dist.Dist15); Angle30 = parseFloat(data.dist.Dist30);
            Angle45 = parseFloat(data.dist.Dist45); Angle60 = parseFloat(data.dist.Dist60); Angle75 = parseFloat(data.dist.Dist75);
            Angle90 = parseFloat(data.dist.Dist90); Angle105 = parseFloat(data.dist.Dist105); Angle120 = parseFloat(data.dist.Dist120);
            Angle135 = parseFloat(data.dist.Dist135); Angle150 = parseFloat(data.dist.Dist150); Angle165 = parseFloat(data.dist.Dist165);
            Angle180 = parseFloat(data.dist.Dist180); 
            
            NoAngle15 = parseFloat(data.dist.Dist195); NoAngle30 = parseFloat(data.dist.Dist210); NoAngle45 = parseFloat(data.dist.Dist225);
            NoAngle60 = parseFloat(data.dist.Dist240); NoAngle75 = parseFloat(data.dist.Dist255); NoAngle90 = parseFloat(data.dist.Dist270);
            NoAngle105 = parseFloat(data.dist.Dist285); NoAngle120 = parseFloat(data.dist.Dist300); NoAngle135 = parseFloat(data.dist.Dist315);
            NoAngle150 = parseFloat(data.dist.Dist330); NoAngle165 = parseFloat(data.dist.Dist345);
            Average = parseFloat(data.dist.Average);

            rgb0 = data.rgb.rgb0; rgb15 = data.rgb.rgb15; rgb30 = data.rgb.rgb30;
            rgb45 = data.rgb.rgb45; rgb60 = data.rgb.rgb60; rgb75 = data.rgb.rgb75;
            rgb90 = data.rgb.rgb90; rgb105 = data.rgb.rgb105; rgb120 = data.rgb.rgb120;
            rgb135 = data.rgb.rgb135; rgb150 = data.rgb.rgb150; rgb165 = data.rgb.rgb165;
            rgb180 = data.rgb.rgb180; rgb195 = data.rgb.rgb195; rgb210 = data.rgb.rgb210;
            rgb225 = data.rgb.rgb225; rgb240 = data.rgb.rgb240; rgb255 = data.rgb.rgb255;
            rgb270 = data.rgb.rgb270; rgb285 = data.rgb.rgb285; rgb300 = data.rgb.rgb300;
            rgb315 = data.rgb.rgb315; rgb330 = data.rgb.rgb330; rgb345 = data.rgb.rgb345;

            for (var i = 0; i < 360; i += 15) {
                $('.color' + i).css('background-color', data.rgb['rgb' + i]);
            }
        }
    });
}
