...
x_values = np.array([-10, -5, 0, 5, 10, 20, 30, 40, 50], dtype=float)

MQ = input("Please define the sensor name: ")
input_values = input("Enter the Y (Rs/Ro) values: (RH33: y1,y2,y3,y4,y5,y7,y9,y11,y13), (RH85: y1,y2,y3,y4,y5,y7,y9,y11,y13): ")
